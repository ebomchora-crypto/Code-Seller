  ...
  return createPortal(
    <AnimatePresence>
      ...
      <motion.button
        ...
        className="absolute inset-0 bg-[#08060d]/55 backdrop-blur-sm"
      />
      <motion.div
        role="dialog"
        aria-modal="true"
        ...
        className="relative flex h-full w-full max-w-md flex-col overflow-y-auto border-[var(--panel-border)] bg-[var(--panel-bg)] shadow-[var(--shadow-modal)] sm:m-2.5 sm:h-[calc(100%-20px)] sm:rounded-[24px] sm:border"
      >
        <div className="flex items-center justify-between border-b border-[var(--border-subtle)] px-6 py-5">
          ...
          <button
            ...
            className="flex size-9 items-center justify-center rounded-full border border-[var(--border-default)] text-[var(--text-muted)] transition-colors hover:bg-[var(--bg-muted)] hover:text-[var(--text-primary)]"
          >
